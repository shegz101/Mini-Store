...
const reducer = (state, action) => {
    ...
    switch (action.type) {
        case 'ADD_TO_CART':
            ...
            return {...state, ...all_total(state.cartObject), cartObject: [ ...state.cartObject,  {...action.payload, quantity:1}]};
        case 'REMOVE_FROM_CART':
            ...
            return {...state, ...all_total(state.cartObject.filter((cart_item) => cart_item.id !== action.id)), cartObject: newCartObject}
        case 'INCREMENT':
            ...
            return {...state, ...all_total(state.cartObject), cartObject:[...state.cartObject]}
        case 'DECREMENT':
            ...
            return {...state, ...all_total(state.cartObject), cartObject:[...state.cartObject]}
        case 'CLEAR':
            return { cartObject: [], ...all_total([]),}
        case 'CHECKOUT':
            return { cartObject: [],check: true, ...all_total([]),}
        default:
            return state
    }
}
